...
export const metadata: Metadata = {
  title: "Next.js Coming Soon Page | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Coming Soon page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
