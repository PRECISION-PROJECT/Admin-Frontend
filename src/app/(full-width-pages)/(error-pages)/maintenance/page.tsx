...
export const metadata: Metadata = {
  title: "Next.js Maintenance Page | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Maintenance page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
      ...
      <div>
        ...
        <p className="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {new Date().getFullYear()} - Precision Admin
        </p>
      </div>
    </div>
  );
