...
export const metadata: Metadata = {
  title: "Next.js Success Page | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Success page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
