...
export const metadata: Metadata = {
  title: "Next.js Popovers | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Popovers page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
