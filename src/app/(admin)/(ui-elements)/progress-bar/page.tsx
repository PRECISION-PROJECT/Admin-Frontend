...
export const metadata: Metadata = {
  title: "Next.js Progress | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Progress page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
