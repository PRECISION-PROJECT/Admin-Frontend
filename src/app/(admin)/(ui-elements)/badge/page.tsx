...
export const metadata: Metadata = {
  title: "Next.js Badge | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
