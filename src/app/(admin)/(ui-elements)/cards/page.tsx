...
export const metadata: Metadata = {
  title: "Next.js Cards | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Cards page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
