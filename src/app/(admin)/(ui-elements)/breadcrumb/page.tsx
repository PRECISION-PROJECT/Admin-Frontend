...
export const metadata: Metadata = {
  title: "Next.js Breadcrumbs | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Breadcrumbs page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
