...
export const metadata: Metadata = {
  title: "Next.js List | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js List page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
