...
export const metadata: Metadata = {
  title: "Next.js Carousel | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Carousel page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
