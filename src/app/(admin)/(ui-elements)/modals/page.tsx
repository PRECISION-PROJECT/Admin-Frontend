...
export const metadata: Metadata = {
  title: "Next.js Modals | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
