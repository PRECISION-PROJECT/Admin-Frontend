...
export const metadata: Metadata = {
  title: "Next.js Button Groups | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Button Groups page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
