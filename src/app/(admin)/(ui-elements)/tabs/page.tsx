...
export const metadata: Metadata = {
  title: "Next.js Tabs | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Tabs page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
