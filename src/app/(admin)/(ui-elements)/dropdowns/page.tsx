...
export const metadata: Metadata = {
  title: "Next.js Dropdowns | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Dropdowns page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
