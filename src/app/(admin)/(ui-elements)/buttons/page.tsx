...
export const metadata: Metadata = {
  title: "Next.js Buttons | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
