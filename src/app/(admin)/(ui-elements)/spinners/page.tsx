...
export const metadata: Metadata = {
  title: "Next.js Spinners | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Spinners page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
