...
export const metadata: Metadata = {
  title: "Next.js Avatars | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
