...
export const metadata: Metadata = {
  title: "Next.js Link | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Link page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
