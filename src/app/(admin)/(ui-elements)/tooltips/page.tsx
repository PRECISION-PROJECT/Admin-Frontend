...
export const metadata: Metadata = {
  title: "Next.js Tooltips | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Tooltips page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
