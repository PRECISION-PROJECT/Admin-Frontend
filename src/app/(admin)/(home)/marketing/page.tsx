...
export const metadata: Metadata = {
  title:
    "Next.js Marketing Dashboard | Precision Admin - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Marketing Dashboard page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
