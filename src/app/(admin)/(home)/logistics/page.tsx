...
export const metadata: Metadata = {
  title: "Next.js Logistics Dashboard | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js  Logistics Dashboard for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
