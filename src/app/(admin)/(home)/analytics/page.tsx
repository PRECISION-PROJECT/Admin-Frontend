...
export const metadata: Metadata = {
  title: "Next.js Analytics Dashboard | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Analytics Dashboard page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
