...
export const metadata: Metadata = {
  title: "Next.js CRM Dashboard | Precision Admin - Next.js Admin Dashboard Template",
  description:
    "This is Next.js CRM Dashboard page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
