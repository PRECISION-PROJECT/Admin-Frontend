...
export const metadata: Metadata = {
  title: "Next.js Support Reply | Precision Admin - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Support Reply for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
