...
export const metadata: Metadata = {
  title: "Next.js Pie Chart | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Pie Chart page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
