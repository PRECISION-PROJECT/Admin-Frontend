...
export const metadata: Metadata = {
  title: "Next.js Line Chart | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Line Chart page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
