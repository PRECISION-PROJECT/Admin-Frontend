...
export const metadata: Metadata = {
  title: "Next.js FAQ Page | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js FAQ page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
