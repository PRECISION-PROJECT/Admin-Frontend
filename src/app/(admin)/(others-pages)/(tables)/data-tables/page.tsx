...
export const metadata: Metadata = {
  title: "Next.js Advanced Data Table | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Advanced Data Table page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
