...
export const metadata: Metadata = {
  title:
    "Next.js AI Video Generator | Precision Admin - Next.js Admin Dashboard Template",
  description:
    "This is Next.js AI Video Generator page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
