...
export const metadata: Metadata = {
  title: "Next.js Messages | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Messages page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
