...
export const metadata: Metadata = {
  title:
    "Next.js E-commerce  Create Invoice Page | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js E-commerce  Create Invoice Page Precision Admin Dashboard Template",
};
