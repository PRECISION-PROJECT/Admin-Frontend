...
export const metadata: Metadata = {
  title:
    "Next.js E-commerce Single Transaction | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js E-commerce Single Transaction Precision Admin Dashboard Template",
};
