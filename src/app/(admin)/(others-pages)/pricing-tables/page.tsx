...
export const metadata: Metadata = {
  title: "Next.js Pricing Table | Precision Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Pricing Table page for Precision Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
