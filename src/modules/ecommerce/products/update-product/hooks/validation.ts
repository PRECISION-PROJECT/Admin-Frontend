...
export const productFormSchema = z.object({
  ...
  existingImage: z.custom<IMedia>().optional(),
  existedImages: z.array(z.custom<IMedia>()).optional(),
});

export type UpdateProductFormData = z.infer<typeof productFormSchema>;
